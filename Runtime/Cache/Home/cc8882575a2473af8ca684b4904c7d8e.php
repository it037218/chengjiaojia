						...
						<?php switch($form["type"]): case "text": ?><div class="controls">
                            ...
                            <?php case "picture": ?><div class="controls uploadrow">
                                ...
                                <div class="upload-img-box">
                                  <?php if(!empty($form['value'])): ?><div class="upload-pre-item"><img width="120" height="120" src="/chengjiao<?php echo (get_cover($form['value'],'path')); ?>"/></div><?php endif; ?>
                                </div>
                              </div>
                              <script type="text/javascript">
                                    //上传图片
                                    ...
                                    $("#upload_picture_<?php echo ($o_key); ?>").uploadify({
                                        "height"          : 120,
                                        "swf"             : "/chengjiao/Public/static/uploadify/uploadify.swf",
                                    ...
                                    function uploadPicture<?php echo ($o_key); ?>(file, data){
                                        ...
                                        if(data.status){
                                            ...
                                            src = data.url || '/chengjiao' + data.path;
...
if(weixin_cover_picurl==undefined || weixin_cover_picurl==""){
	$('.weixin-cover-pic').attr('src',"/chengjiao/Public/Home/images/no_cover.png");
}else{
